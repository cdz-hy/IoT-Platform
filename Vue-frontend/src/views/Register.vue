      ...
      <div class="liquid-glass-panel login-bento">
        ...
        <div class="bento-form">
          ...
          <el-form :model="form" :rules="rules" ref="formRef" class="login-form">
            ...
            <button class="fd-btn fd-btn-primary login-btn" @click.prevent="handleRegister" :disabled="loading">
...
const handleRegister = async () => {
  ...
  try {
    await register(form.username, form.password, form.nickname || null)
